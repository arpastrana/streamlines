...
if __name__ == '__main__':
    ...
    HERE = '/Users/arpj/code/libraries/streamlines/examples/knitcandela.json'
    ...
    NUM = 50  # number of clusters
    ITERS = 50  # number of iterations
    MERGESPLIT = False  # kmeans activate merge split clusters

    THERE = '/Users/arpj/code/libraries/streamlines/examples/gif/knitcandela/kmeans_{}_{}_'
    ...
    all_clusters = k_means(sel_clusters, faces, ITERS, MERGESPLIT, callback)
